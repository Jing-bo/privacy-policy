# "Radio Cloud" PRIVACY POLICY 

This privacy policy governs your use of the software application Radio Cloud ("Application") for mobile devices that was created by Aaron Zhao. The Application is a simple mobile app that gives users access to radio stations worldwide. The Application is published on Google Play only.
 
# What information does the Application obtain and how is it used?

## User Provided Information 
No data was collected by us. All loan data can only be saved locally in your device and we have no way to access it.

## Automatically Collected Information 
No data was collected by us.
